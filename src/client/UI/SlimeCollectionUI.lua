...
function SlimeCollectionUI.LoadSlimes(gridContainer: ScrollingFrame)
	...
	local slimes = SlimeFactory:GetPlayerSlimes(Players.LocalPlayer)
...
function SlimeCollectionUI.SelectSlime(slime: any)
	...
	slimeVisual.Position = UDim2.fromScale(0.5, 0.2)
	slimeVisual.AnchorPoint = Vector2.new(0.5, 0.5)
	slimeVisual.BackgroundColor3 = ELEMENT_COLORS[slime.Element] or ELEMENT_COLORS.Normal
	...
	nameLabel.Position = UDim2.fromScale(0, 0.38)
	nameLabel.BackgroundTransparency = 1
	nameLabel.TextColor3 = COLORS.Text
	nameLabel.Font = Enum.Font.GothamBold
	...
	rarityLabel.Position = UDim2.fromScale(0, 0.54)
	...
	levelLabel.Position = UDim2.fromScale(0, 0.62)
	...
	statsFrame.Size = UDim2.fromScale(1, 0.25)
	statsFrame.Position = UDim2.fromScale(0, 0.72)
	...
	if slime.ContextPoints and slime.ContextPoints > 0 then
		...
		contextLabel.Position = UDim2.fromScale(0, 0.92)
