...
local EtymologyDB = {
    Roots = {
		...
		["Phot"] = {
			Element = "Light",
			StatFocus = "Speed",
			Color = Color3.fromRGB(250, 250, 110), -- Lemon Yellow
			Examples = {"Photon", "Photography"}
		},
		["Therm"] = {
			Element = "Fire",
			StatFocus = "Pathos",
			Color = Color3.fromRGB(220, 38, 38), -- Crimson
			Examples = {"Thermal", "Thermometer"}
		},
		["Geo"] = {
			Element = "Earth",
			StatFocus = "Ethos",
			Color = Color3.fromRGB(132, 204, 22), -- Lime Green
			Examples = {"Geology", "Geography"}
		},
		["Hydr"] = {
			Element = "Water",
			StatFocus = "Ethos",
			Color = Color3.fromRGB(14, 165, 233), -- Sky Blue
			Examples = {"Hydrate", "Hydraulic"}
		},
		["Helio"] = {
			Element = "Light",
			StatFocus = "Speed",
			Color = Color3.fromRGB(253, 186, 116), -- Peach
			Examples = {"Heliocentric", "Heliotrope"}
		},
		["Nyct"] = {
			Element = "Shadow",
			StatFocus = "Speed",
			Color = Color3.fromRGB(15, 23, 42), -- Midnight
			Examples = {"Nyctophobia", "Nyctalopia"}
		},
		["Sci"] = {
			Element = "Light",
			StatFocus = "Logos",
			Color = Color3.fromRGB(248, 113, 113), -- Red-Light
			Examples = {"Science", "Omniscient"}
		},
		["Cred"] = {
			Element = "Earth",
			StatFocus = "Ethos",
			Color = Color3.fromRGB(163, 230, 53), -- Chartreuse
		...
		["Bio"] = {
			Element = "Water",
			StatFocus = "Pathos",
			Color = Color3.fromRGB(52, 211, 153), -- Mint
			Examples = {"Biology", "Biography"}
		},
		["Dict"] = {
			Element = "Air",
			StatFocus = "Logos",
			Color = Color3.fromRGB(203, 213, 225), -- Slate
			Examples = {"Dictate", "Prediction"}
		},
		["Voc"] = {
			Element = "Air",
			StatFocus = "Pathos",
			Color = Color3.fromRGB(148, 163, 184), -- Darker Slate
			Examples = {"Vocal", "Advocate"}
		},
		["Lumina"] = {
			Element = "Light",
			StatFocus = "Ethos",
			Color = Color3.fromRGB(254, 240, 138), -- Pale Yellow
			Examples = {"Illuminate", "Luminescent"}
		}
    } :: { [string]: RootData },
