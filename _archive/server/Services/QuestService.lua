...
local QuestDefinitions: { [string]: any } = {
    ...
    ["quest_starter"] = {
        ...
        Description = "The city's heartbeat is faint. Capture your first Etymon and fabricate a Slime of Hope to begin the resonance.",
        Steps = {
            ["step_1"] = { Id = "step_1", Type = "Collect", TargetId = "H", Amount = 1, Description = "Collect 'H' Crystal" },
            ["step_2"] = { Id = "step_2", Type = "Collect", TargetId = "O", Amount = 1, Description = "Collect 'O' Crystal" },
            ["step_3"] = { Id = "step_3", Type = "Collect", TargetId = "P", Amount = 1, Description = "Collect 'P' Crystal" },
            ["step_4"] = { Id = "step_4", Type = "Collect", TargetId = "E", Amount = 1, Description = "Collect 'E' Crystal" },
            ["step_5"] = { Id = "step_5", Type = "interact", TargetId = "Fabricator", Amount = 1, Description = "Fabricate 'HOPE'" },
        },
        Rewards = { XP = 100, Insight = 50 }
    },
    -- Tutorial Quest
    ["quest_tutorial"] = {
        Id = "quest_tutorial",
...
function QuestService:AssignFirstQuest(player: Player)
    self:AcceptQuest(player, "quest_starter")
end
