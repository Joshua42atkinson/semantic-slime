...
local BuildingStyles: { [string]: StyleDefinition } = {
	BrainyBorough = {
		...
		SecondaryColor = Color3.fromHex("#1E3A8A"), -- BrainyBorough Blue
		RoofType = "Wedge",
	...
	HeartwoodGrove = {
		...
		SecondaryColor = Color3.fromHex("#065F46"), -- HeartwoodGrove Green
	...
	WhisperWinds = {
		...
		SecondaryColor = Color3.fromHex("#5B21B6"), -- WhisperWinds Purple
		RoofType = "Spire",
	...
	ActionAlley = {
		...
		SecondaryColor = Color3.fromHex("#991B1B"), -- ActionAlley Red
		RoofType = "Flat",
