...
function QuestLog.Create(): Frame
	...
	title.TextSize = 20
	title.Text = "📜 Archetype Manifestations"
...
function QuestLog.Initialize()
	print("[QuestLog] Initializing quest log UI...")
	
	-- Create the main quest log container if it doesn't exist
	local player = Players.LocalPlayer
	local playerGui = player:WaitForChild("PlayerGui")
	
	if not playerGui:FindFirstChild("QuestLogContainer") then
		questContainer = Instance.new("Frame")
		questContainer.Name = "QuestLogContainer"
		questContainer.Size = UDim2.new(0.3, 0, 0.6, 0)
		questContainer.Position = UDim2.new(0.7, -20, 0.2, 0)
		questContainer.BackgroundColor3 = COLORS.Background
		questContainer.BorderSizePixel = 0
		questContainer.Parent = playerGui
		
		local corner = Instance.new("UICorner")
		corner.CornerRadius = UDim.new(0, 12)
		corner.Parent = questContainer
		
		local stroke = Instance.new("UIStroke")
		stroke.Color = COLORS.Accent
		stroke.Thickness = 2
		stroke.Transparency = 0.5
		stroke.Parent = questContainer
		...
		header.Parent = questContainer
		
		-- Quest list container
		local listContainer = Instance.new("ScrollingFrame")
		listContainer.Name = "QuestList"
		listContainer.Size = UDim2.new(1, -20, 1, -60)
		listContainer.Position = UDim2.fromOffset(10, 50)
		listContainer.BackgroundTransparency = 1
		listContainer.BorderSizePixel = 0
		listContainer.Parent = questContainer
	...
	print("[QuestLog] Quest log UI initialized successfully")
end
